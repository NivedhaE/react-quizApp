export const data =[
    {
        ...
        option1:"Display content",
        option2:"Meta-information",
        option3:"Link websites",
        option4:"Navigation",
        ans:2
    },
    {
    ...
    },
    {
        ...
        option1:"No meaning",
        option2:"Style webpage",
        option3:"Describe meaning",
        option4:"Navigation",
        ans:3
    },
    {
        question:"What is the difference between class and id selectors in CSS?",
        option1:"Single vs. multiple",
        option2:"Hash vs. dot",
        option3:"Multiple vs. single",
        option4:"Text vs. containers",
        ans:3
    },
    {
...
<<<<<<< HEAD
    },
    {
        ...
        option1:"To manage the lifecycle of a component",
        option2:"To fetch data from an API",
        option3:"To add CSS styles to a component",
        option4:"To manage state within a functional component",
        ans:4
    },
    {
        question:"What is JSX in React?",
        option1:"A JavaScript function used to create components",
